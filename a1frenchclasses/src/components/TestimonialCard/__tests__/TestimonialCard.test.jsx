...
describe('TestimonialCard', () => {
  ...
  it('renders customer photo with correct alt text', () => {
    ...
    const photo = screen.getByAltText('Sarah Johnson profile photo');
  ...
  it('renders star rating correctly for full stars', () => {
    ...
    const starRating = screen.getByRole('img', { name: '5 out of 5 stars' });
  ...
  it('renders star rating correctly for partial rating', () => {
    ...
    const starRating = screen.getByRole('img', { name: '4.5 out of 5 stars' });
    expect(starRating).toBeInTheDocument();
  ...
  it('renders star rating correctly for lower rating', () => {
    ...
    const starRating = screen.getByRole('img', { name: '3 out of 5 stars' });
    expect(starRating).toBeInTheDocument();
  ...
  it('handles image loading error with fallback', () => {
    ...
    expect(photo).toHaveAttribute('src', '/images/placeholder-avatar.jpg');
  });
  ...
  it('has proper accessibility attributes', () => {
    ...
    const starRating = screen.getByLabelText('5 out of 5 stars');
